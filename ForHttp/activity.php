...
?>
<?php $AllMsg=mysql_query("select InfoNo,ActContent,ActTime,ActTitle ,ActLocation ,ActPicture
							from activity
							order by InfoNo desc"); ?>
<?php $Page = $_GET['Page'] ;
if ($Page == null)
{
	echo '<meta http-equiv=REFRESH CONTENT=0;url=activity.php?Page=1>';
}
?>
<!--html-->
<!DOCTYPE html>
...
<div class="container">
	...
	<div class="row">
	  <div class="col-xs-12 col-sm-12">	
			...
			<li role="presentation" class="active"><a href="activity.php?Page=1">活動記錄</a></li>			
	...
	<div class="row">	
	  ...
	  <div class="col-xs-7 col-sm-7">
		  ...
		  <div class="panel panel-default">
			<div class="panel-heading" role="tab" id="heading1">
			  <h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
					<!--標題1-->
				  <?php echo $rs["ActTitle"] ?>
				  <div style="float:right;"> <?php echo date("Y-m-d H:i:s",strtotime($rs["ActTime"])); ?> </div>
				  <?php if(isset($_SESSION['Account'])) : ?><!--假如有留下session-->
					<?php if($row_S[0]): ?><!--假如是管理員-->
					<div style="text-align:right;"><a href = "delactivity.php?InfoNo=<?php echo $rs["InfoNo"];?>" style="color:red;">刪除活動</a></div>		 
					<?php endif ;?>
				  <?php endif ;?>
				</a>
			  </h4>
			...
			<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
			  <div class="panel-body">
					<!--內文1-->
					<?php echo "地點 : ".$rs["ActLocation"]; ?> 
					</br></br>
					<?php echo "內容 : ".$rs["ActContent"]; ?>
					</br></br>
					<?php echo '<img src="activitypicture/'.$rs["ActPicture"].'" class="img-responsive" alt="Responsive image">'; ?>
			  </div>
			</div>
		  </div>
		  <?php } ?>
		...
		<nav>
		  <ul class="pagination">
			<li><a href="activity.php?Page=1">1 <span class="sr-only">(current)</span></a></li>
			<li><a href="activity.php?Page=2">2</a></li>
			<li><a href="activity.php?Page=3">3</a></li>
			<li><a href="activity.php?Page=4">4</a></li>
			<li><a href="activity.php?Page=5">5</a></li>
		<nav>
		  </ul>
		</nav>
		...
		<?php if(isset($_SESSION['Account'])) : ?><!--假如有留下session-->
			<?php if($row_S[0]): ?><!--假如是管理員-->
					<div style="text-align:right;"><a href="addactivity.php" class="btn btn-primary" role="button">新增活動</a></div>	
			<?php endif ;?>
		<?php endif ;?>
