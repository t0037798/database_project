	  ...
	  <div class="col-xs-7 col-sm-7">
		...
		<?php if(isset($_SESSION['Account'])) : ?><!--假如有留下session-->
			<?php if($row_S[0]): ?><!--假如是管理員-->
				...
				<form name="form" method="post" action="newpublish.php">
					<div class="form-group">
						<label for="exampleInputEmail1">公告名稱</label>
						<input type="text" class="form-control" name="AncTitle" placeholder="請輸入公告名稱">
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1">公告內容</label>
						<textarea class="form-control" rows="8" name="AncContent" placeholder="輸入公告內容"></textarea>
					</div>		
					</br>
